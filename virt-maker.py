...
parser.add_argument('--show-variables','-sv',     action="store_true", dest='show_variables', default=False,  help='Shows the input variables for a given *.vbp file')
parser.add_argument('--show-blueprint','-sb',     action="store_true", dest='show_blueprint',  default=False, help='Shows the input blueprint for a given *.vbp file')
...
parser.add_argument('--input-format','if',        action="store",      dest='input_format',   default='KEY',  help='Set the input format (JSON|Key).  Default KEY')
