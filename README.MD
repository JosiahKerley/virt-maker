...
=============
```
usage: virt-maker [-h] [--file [VBPFILEPATH [VBPFILEPATH ...]]] [--build]
                  [--noop] [--list-store]
...
optional arguments:
  ...
  --show-variables      Shows the input variables for a given *.vbp file
  --show-blueprint      Shows the input blueprint for a given *.vbp file
